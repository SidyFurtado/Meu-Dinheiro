...
// Ativa a persistência offline do Firestore com proteção contra erros síncronos
try {
  ...
  console.error("Erro síncrono crítico ao ativar persistência offline do Firestore:", error);
}
